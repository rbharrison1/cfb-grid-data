...
Third copy in the fork lineage: cfb-grid-python/mern/python/v2/config/teams.py
-> transform/config/teams.py (BigQuery-transform migration) -> this file
(live-scores service). Keep all copies in sync until/unless this becomes a
shared, single-sourced lookup -- same convention transform/config/teams.py
already documents for its own fork from cfb-grid-python.

Used here as the first fallback tier when resolving an NCAA scoreboard team
name to the display name already stored in Mongo's away_team/home_team
fields (see team_match.py) -- Mongo's stored names are CFBD names already
run through this same substitution table, so this maps NCAA's raw name into
that same display-name space before falling back to NCAA_NAME_ALIASES.
"""
...
TEAM_NAME_SUBSTITUTIONS = {
    ...
    'Georgetown College Kentucky': 'Georgetown (KY)',
    'Missouri Southern State': 'Missouri So. St.',
    ...
    'Western New Mexico': 'W. New Mexico',
    'Case Western Reserve': 'Case Western',
    'Western New England': 'W. New England',
    'Worcester State': 'Worcester St.',
    'Truman State': 'Truman St.',
    'Claremont Mudd Scripps': 'Cl.-Mudd-Scripps',
    'American International': 'American Int\'l',
    'Eastern New Mexico': 'E. New Mexico',
    'Texas A&M-Kingsville': 'TAMU-Kingsville',
    'Washington St. Louis': 'Wash. St. Louis',
    'Vermont State Castleton': 'VT St. Castleton',
    'Western Connecticut State': 'W. Connecticut St.',
    'Wisconsin Stevens Point': 'WI-Stevens Point',
    'The College of New Jersey': 'TCNJ',
    'North Carolina Wesleyan': 'NC Wesleyan',
    'Mayville State': 'Mayville St.',
    'Western Connecticut State': 'W. Connecticut St.',
